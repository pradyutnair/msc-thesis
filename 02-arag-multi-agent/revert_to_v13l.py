"""Revert _compare_by_date back to v13l's index-based entity extraction.
Also revert comparison patterns to v13l (same as v13k originals).
"""
...
# Replace content-based _compare_by_date with v13l's index-based version
...
assert old in content, "Old content-based _compare_by_date not found"
...
print("Reverted to v13l index-based _compare_by_date")
