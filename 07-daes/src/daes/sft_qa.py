...
class DiffusionTrainer(Trainer):
    ...
    def compute_loss(self, model, inputs, num_items_in_batch=None, return_outputs=False):
        ...
        # Dream-specific: AR-shift (position i predicts token at i+1)
        # Shift logits LEFT to align with labels at same positions
...
def main():
    ...
    parser.add_argument("--data_path", default="/projects/prjs1800/msc-thesis/07-daes/data/qwen_matched_sft.jsonl")
    parser.add_argument("--output_dir", default="/projects/prjs1800/msc-thesis/07-daes/models/dream_qa_sft")
    ...
    # Dream doesn't have prepare_inputs_for_generation - add dummy for PEFT compatibility
