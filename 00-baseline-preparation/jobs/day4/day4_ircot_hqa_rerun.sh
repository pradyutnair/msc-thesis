...
#SBATCH --output=/projects/prjs1800/msc-thesis/jobs/output/day4/ircot_hqa_rerun_%j.log
#SBATCH --error=/projects/prjs1800/msc-thesis/jobs/output/day4/ircot_hqa_rerun_%j.log

echo "=========================================="
echo "Day 4: IRCoT HotpotQA Re-run"
...
python scripts/day4/run_ircot_rag.py \
    --config configs/day4/ircot_qwen25_hotpotqa.yaml \
    --max_iter 5
