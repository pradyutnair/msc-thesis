...
JOB_DIR="$ROOT/jobs/generated_b0_nonagentic"
...
MODELS=(
  "q25_7b|Qwen/Qwen2.5-7B-Instruct|Qwen2.5-7B-Instruct|gpu_a100|08:00:00|arag_qwen25_vllm_e5|b0-qwen25-7b-e5-deepseekr1"
  "q3_8b|Qwen/Qwen3-8B|Qwen3-8B|gpu_a100|08:00:00|arag_qwen3_vllm_e5|b0-qwen3-8b-e5-deepseekr1"
...
echo "Submitting B0 non-agentic pipelines (B0-7B, B0-8B, B0-30B)"
