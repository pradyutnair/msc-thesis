#!/bin/bash
#SBATCH --job-name=arag_2wikimultihopqa
#SBATCH --partition=gpu_a100
#SBATCH --gres=gpu:1
#SBATCH --time=12:00:00
#SBATCH --mem=96G
#SBATCH --cpus-per-task=16
#SBATCH --output=/projects/prjs1800/results/logs/%j_arag_2wikimultihopqa.out
#SBATCH --error=/projects/prjs1800/results/logs/%j_arag_2wikimultihopqa.err
